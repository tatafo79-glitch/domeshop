...
('goods_register', 'margin_rate', '20', 'float', '기본 마진율'),
...
('goods_register', 'image_min_width', '600', 'int', '원본 최소 가로 크기'),
('goods_register', 'image_min_height', '600', 'int', '원본 최소 세로 크기'),
('goods_register', 'image_max_upload_mb', '20', 'int', '원본 업로드 허용 용량'),
('goods_register', 'thumb_list_fit', 'CONTAIN', 'string', '목록이미지 노출방법'),
('goods_register', 'thumb_list_size', '600', 'int', '목록이미지 기준 크기'),
('goods_register', 'thumb_detail_fit', 'CONTAIN', 'string', '상세이미지 노출방법'),
('goods_register', 'thumb_detail_size', '1000', 'int', '상세이미지 기준 크기'),
('goods_register', 'thumb_detail_list_fit', 'CONTAIN', 'string', '상세목록이미지 노출방법'),
('goods_register', 'thumb_detail_list_size', '300', 'int', '상세목록이미지 기준 크기'),
('goods_register', 'thumb_etc_list_fit', 'CONTAIN', 'string', '기타목록이미지 노출방법'),
('goods_register', 'thumb_etc_list_size', '120', 'int', '기타목록이미지 기준 크기'),
